...
export default function Main() {
	return (
		<main className="flex min-h-screen w-full flex-col">
			<section className="flex flex-col items-center justify-center py-32">
				...
				<div className="mt-20 flex space-x-5">
					...
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 338.66 408.87"
							className="mr-2 h-6 w-6 fill-current"
						>
							<path d="M20,408.87c-3.13-1.38-6.53-2.37-9.35-4.24C3.31,399.77,0,392.58,0,383.89q0-105.4,0-210.81c0-5.44,2.05-8.53,6.11-9.47,4.26-1,8.16,1.13,9.31,5.33a20.78,20.78,0,0,1,.52,5.52q0,103.41,0,206.82c0,9.24,2.36,11.62,11.55,11.62H311.05c9.25,0,11.63-2.36,11.63-11.54V27.62c0-9.26-2.36-11.64-11.53-11.64H156.61a29,29,0,0,1-4.38-.16,7.75,7.75,0,0,1-7-7.9c0-4.05,2.83-7.15,7.12-7.77A25.1,25.1,0,0,1,156,0Q234.23,0,312.5,0c16.18,0,26.15,10,26.15,26.14q0,178.27,0,356.54c0,13.61-4.93,20-20,26.18Z" />
							<path d="M100.35,196.17a80.33,80.33,0,0,1,40.32-34.29c-3.16-6.55-7.36-12.51-8.93-19.09-4.35-18.25-1.15-36.22,13.74-48.1C166,78.33,198.53,87.92,206.12,113c4.22,14,4,27.83-3.69,40.82-1.47,2.5-3.43,4.71-5.52,7.55,17.53,6.94,31.43,18.19,41.34,34.7A84.17,84.17,0,0,0,254,169.21c18.8-52-12.5-108.4-66.62-119.27-9-1.81-18.49-1-27.76-1.35-1.58-.06-3.18.25-4.78.25-4.58,0-7.85-2.72-8.38-6.86a7.64,7.64,0,0,1,6.56-8.6A104.42,104.42,0,0,1,168.9,32a106.41,106.41,0,0,1,104.41,84.73c11.95,57.64-25.94,114.47-83.76,125.64A106.34,106.34,0,0,1,64.91,157.63c-1.06-5.49,1.15-9.68,5.65-10.71,5-1.15,8.94,1.73,10,7.68a89.61,89.61,0,0,0,18,39.51C99.05,194.73,99.59,195.3,100.35,196.17Zm11.89,11.54c32.6,28.26,84.32,26.62,113.81-.05-9.49-20.94-33.25-35.77-57.28-35.07C143.24,173.34,124.49,185.37,112.24,207.71Zm80.22-78.09c0-1.63.06-3.09,0-4.55-.63-12.84-10.85-22.78-23.24-22.65a23.26,23.26,0,0,0-23,22.49,73.1,73.1,0,0,0,.1,10.36,23,23,0,0,0,35,17.75C190.07,147.66,193.07,139.34,192.46,129.62Z" />
							<path d="M65.31,131C29.25,130.83-.19,101.18,0,65.2S29.91-.26,65.88,0A65.47,65.47,0,0,1,65.31,131Zm.23-115A49.5,49.5,0,1,0,115,65.53,49.64,49.64,0,0,0,65.54,16Z" />
							<path d="M186.09,289.09H133a33,33,0,0,1-3.59-.07c-4.48-.49-7.55-3.67-7.62-7.81s3.14-7.58,7.8-8c.66-.06,1.33,0,2,0H241c.67,0,1.34,0,2,0,4.79.41,7.88,3.47,7.93,7.84.06,4.55-3.1,7.87-8.11,8-5.85.19-11.71.06-17.57.06Z" />
							<path d="M186.5,333.81H132.6a22.82,22.82,0,0,1-4-.19,7.86,7.86,0,0,1,.15-15.61,25.1,25.1,0,0,1,4-.16h107c1.06,0,2.13,0,3.19,0,4.79.39,7.88,3.45,7.94,7.82.07,4.55-3.09,7.82-8.1,8.06-3.85.18-7.72.05-11.58.05Z" />
							<path d="M95.42,289a7.93,7.93,0,1,1,8-7.81A8.09,8.09,0,0,1,95.42,289Z" />
							<path d="M95.66,333.75a7.93,7.93,0,0,1-.21-15.86,7.93,7.93,0,0,1,.21,15.86Z" />
							<path d="M8.13,133.43a7.92,7.92,0,1,1-.28,15.84,7.92,7.92,0,0,1,.28-15.84Z" />
							<path d="M56.53,72.16c8-8.06,15.74-15.77,23.46-23.45a29.87,29.87,0,0,1,3.86-3.44,7.71,7.71,0,0,1,9.89.71,7.86,7.86,0,0,1,1,10.18,21.27,21.27,0,0,1-2.6,3q-13.95,14-27.94,27.95c-5.6,5.58-9.37,5.57-15,0-4-3.93-8-7.85-11.84-11.86s-4.12-8.74-.81-12,7.94-3.16,12,.77C51.22,66.56,53.73,69.28,56.53,72.16Z" />
						</svg>
			...
			<section className="container mx-auto mt-32 flex justify-center space-x-10 divide-x divide-dashed divide-almond-white text-eerie-black">
				...
				<div className="max-w-md pl-10">
					<div className="flex flex-grow flex-col items-center justify-center rounded-md bg-almond-white px-10 text-center shadow-lg md:h-72">
						...
						<p>We stick to our timeline. Always.</p>
					</div>
				</div>
				<div className="max-w-md pl-10">
					<div className="flex flex-grow flex-col items-center justify-center rounded-md bg-almond-white px-10 text-center shadow-lg md:h-72">
					...
					<div className="grid max-w-5xl grid-cols-2 gap-y-28 gap-x-5 rounded-xl bg-violet-300/20 p-10 transition-all hover:bg-violet-300/30">
						<div className="self-center">
							...
							<p className="font-heading text-xl font-light tracking-wider">
								...
								adipisicing elit. Sunt vitae eum debitis
								molestiae fugiat assumenda laboriosam laudantium
								alias? Dolore, sit!
							</p>
							<a
								href="#"
			...
			<footer className="border-t border-t-almond-white/20 p-16 backdrop-blur-lg">
				<div className="text-center font-heading text-xs uppercase">
					...
					<p className="flex justify-center">
						...
						<svg
							xmlns="http://www.w3.org/2000/svg"
							className="mx-1 inline h-3 w-3 hover:text-red-500"
							viewBox="0 0 20 20"
							fill="currentColor"
						>
							<path
